...
@InputType()
class RecipeIngredientsCreateNestedManyWithoutIngredientsItemsInput {
...
export { RecipeIngredientsCreateNestedManyWithoutIngredientsItemsInput as RecipeIngredientsCreateNestedManyWithoutIngredientsItemsInput };
