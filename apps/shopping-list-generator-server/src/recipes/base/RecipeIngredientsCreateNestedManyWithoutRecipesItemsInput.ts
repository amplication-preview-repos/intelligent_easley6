...
@InputType()
class RecipeIngredientsCreateNestedManyWithoutRecipesItemsInput {
...
export { RecipeIngredientsCreateNestedManyWithoutRecipesItemsInput as RecipeIngredientsCreateNestedManyWithoutRecipesItemsInput };
