...
@InputType()
class RecipeIngredientsUpdateManyWithoutRecipesItemsInput {
...
export { RecipeIngredientsUpdateManyWithoutRecipesItemsInput as RecipeIngredientsUpdateManyWithoutRecipesItemsInput };
